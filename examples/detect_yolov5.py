...
def get_objects(interpreter,
  ...
  #print((common.output_tensor(interpreter, 1)))
  # pylint: enable=protected-access
  #print(interpreter.get_output_details())
  #print('Trueeeeeee',common.output_tensor(interpreter,0 ).size)
  if signature_list:
    ...
    scores = result[0,:,4]
    #print('scoresssss',scores)
    boxes = xywh2xyxy(result[0,:,:4])
    
    count = result.shape[1]
    class_ids = result[0,:,5:]
